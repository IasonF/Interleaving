...
%PGK: If you have not already, I suggest referring to Sec. 4 in Sec. 2 to "prove" that the simple model is sufficiently accurate.

\item The commercial memory compiler is one of the state-of-the-art compilers. The logic libraries support a wide range of foundries and process technologies from 250nm to 28nm. The memories are optimized for low power, high performance and high density. A 40nm library was chosen for the current work.  Of confidentiality reasons we are not allowed to reveal details of the compiler or process.
